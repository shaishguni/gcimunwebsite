                ...
                <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
                    <div className="flex flex-col items-center gap-6 text-center">
                        <div className="inline-flex items-center gap-2 rounded-full bg-indigo-50 px-4 py-2">
                            ...
                            <span className="text-sm font-medium text-indigo-600">Registration 2026</span>
                        </div>
                        ...
                        <nav className="mt-6 flex flex-wrap justify-center gap-3">
                            {registrationOptions.map((option) => (
                                <Button
                                    key={option.id}
                                    asChild
                                    className="border border-indigo-100 bg-white text-indigo-600 hover:bg-indigo-50"
                                >
                                    ...
                                    >
                                        <div className="flex flex-col gap-3">
                                            <div>
                                                ...
                                                <p className="mt-1 text-xs font-medium uppercase tracking-[0.3em] text-indigo-600/80">
                                                    Registration Fee
                                                </p>
                                                <p className="text-base font-semibold text-indigo-600">{option.price}</p>
                                            </div>
                    ...
                    <div className="mt-12 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        <div className="flex flex-col gap-4">
                            ...
                            <p className="text-sm leading-relaxed text-slate-600">
                                ...
                                <a className="ml-1 font-medium text-indigo-600 hover:text-indigo-700" href="mailto:gcimun@gci.edu.np">
                                    gcimun@gci.edu.np
                                </a>
                                .
                            </p>
